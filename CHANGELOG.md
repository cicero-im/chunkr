...
## [3.0.0](https://github.com/cicero-im/chunkr/compare/v2.2.1...v3.0.0) (2026-07-03)
...
* /health return current version ([627e8c9](https://github.com/cicero-im/chunkr/commit/627e8c9a1160bf4a360f6d0ea0f1376f64344642))
* Added automation of docker build ([#365](https://github.com/cicero-im/chunkr/issues/365)) ([f01cb2f](https://github.com/cicero-im/chunkr/commit/f01cb2fc66c104066f1188149cdbbb8390337169))
* Added blog pages to frontend - hooked up to Contentful CMS + env toggle for Blog page ([#531](https://github.com/cicero-im/chunkr/issues/531)) ([90d6dd8](https://github.com/cicero-im/chunkr/commit/90d6dd88aa5e6cd0bb0580185a6f4fbf3523e35d))
* Added configuration for `error_handling` which allows you to choose between `Fail` or `Continue` on non-critical errors ([0baca0a](https://github.com/cicero-im/chunkr/commit/0baca0a519b44d139f64d02bec754f259ed329de))
* Added doctr small dockers ([#407](https://github.com/cicero-im/chunkr/issues/407)) ([9b8a56e](https://github.com/cicero-im/chunkr/commit/9b8a56e273f39aa15d3001c6f7ccb707900dd584))
* Added extended context (full page + segment) in `segment_processing` ([#480](https://github.com/cicero-im/chunkr/issues/480)) ([542377b](https://github.com/cicero-im/chunkr/commit/542377b904aef5fb215bdea3f837315a23eb37de))
* Added new cropped image viewing, updated upload component defaults for image VLM processing, and some bug fixes for segment highlighting + JSON viewing ([#388](https://github.com/cicero-im/chunkr/issues/388)) ([6115ee0](https://github.com/cicero-im/chunkr/commit/6115ee08b785e94ed8432e4c75da98e32a42bea9))
* Added new frontend pdfs in new landing page ([#490](https://github.com/cicero-im/chunkr/issues/490)) ([bbaf911](https://github.com/cicero-im/chunkr/commit/bbaf911f205b2f81b723577155e6b5adff246a65))
* Added Open telemetry support for better analytics ([#504](https://github.com/cicero-im/chunkr/issues/504)) ([7baa3d4](https://github.com/cicero-im/chunkr/commit/7baa3d4a03b5bd15c70dd73b00146adf6dfe7ba6))
* Added release please for automated releases ([#363](https://github.com/cicero-im/chunkr/issues/363)) ([d808d4e](https://github.com/cicero-im/chunkr/commit/d808d4e72464b83590dfab73fe973e2f98b4f7e7))
* Added span class instructions for all formula prompts ([#489](https://github.com/cicero-im/chunkr/issues/489)) ([5162f8f](https://github.com/cicero-im/chunkr/commit/5162f8f02fabe8eb0a0f99de1373c5295d3f9ddd))
* Added task level analytics to usage page ([#498](https://github.com/cicero-im/chunkr/issues/498)) ([e4d63ff](https://github.com/cicero-im/chunkr/commit/e4d63ffb86c9d790c8bb13cf0cf71642d2f19e2b))
* Added task retries, started at time, border boxes and more UI enhancements for special segment types like tables, formulas and image descriptions, modified self-host tier based usage section and always showing overage ticker ([#460](https://github.com/cicero-im/chunkr/issues/460)) ([40a4a69](https://github.com/cicero-im/chunkr/commit/40a4a6987f82fa01a5cadcbedeee4264bcdb7916))
* Allow users to choose an LLM model to use for `segment_processing` by setting the `llm_processing.model_id` param in the POST and PATCH request. The available models can be configured using the `models.yaml` file. ([#437](https://github.com/cicero-im/chunkr/issues/437)) ([ea526c4](https://github.com/cicero-im/chunkr/commit/ea526c4c48692ae5d8a9ba00b70008ce238a4c14))
* Chunking can now be configured using `embed_sources` in `segment_processing.{segment_type}` configuration and allows the choice of pre-configured tokenizers or any huggingface tokenizer by setting the `tokenizer` field in `chunk_processing` ([#420](https://github.com/cicero-im/chunkr/issues/420)) ([d88ac64](https://github.com/cicero-im/chunkr/commit/d88ac646ece3935f1c7fcd028bb6c5df0b7d00d3))
* Consolidate HTML/markdown generation into single format choice ([a974f3f](https://github.com/cicero-im/chunkr/commit/a974f3fbc2bd9158ca052c21a121b479e0eb7613))
* **core:** Added compatibility to Google AI Studio ([#380](https://github.com/cicero-im/chunkr/issues/380)) ([f56b74c](https://github.com/cicero-im/chunkr/commit/f56b74c23d1bb0faf050c54a74437139dc9a6938))
* **core:** Improved error messages on task failure and retry only failed steps ([#496](https://github.com/cicero-im/chunkr/issues/496)) ([2e09e11](https://github.com/cicero-im/chunkr/commit/2e09e113f8cf0b0950a77c6954cc9ded2e85c434))
* **core:** Improved image uploads to pdf conversion and added checkbox support ([a2b65ed](https://github.com/cicero-im/chunkr/commit/a2b65ed182dcc07af1bccc5b4e98dec3a3335ed8))
* **core:** Improved telemetry and added timeout around task processing to deal with long running processes ([#511](https://github.com/cicero-im/chunkr/issues/511)) ([bbe5913](https://github.com/cicero-im/chunkr/commit/bbe59130afffedbf5e2e29267afb1f6300918f67))
* **core:** Remove rrq dependency and improve memory management ([92b70dc](https://github.com/cicero-im/chunkr/commit/92b70dceb1188cec926e415ff295127a3fb085cc))
* Created a stable and simple version by removing all extra/unused components ([#570](https://github.com/cicero-im/chunkr/issues/570)) ([7a444ea](https://github.com/cicero-im/chunkr/commit/7a444eac4cab1e4f811997fc513a9f2db97aa5b3))
* Fixed reading of text layer (prevent whitespace inbetween words) ([#461](https://github.com/cicero-im/chunkr/issues/461)) ([8eba7d3](https://github.com/cicero-im/chunkr/commit/8eba7d36d108c736f0d0ca658cf90716c2c0c544))
* Https support for docker compose using nginx ([#434](https://github.com/cicero-im/chunkr/issues/434)) ([868096c](https://github.com/cicero-im/chunkr/commit/868096c8adbb051243e433b2b1c7f440ac1b5997))
* New picture prompts ([#405](https://github.com/cicero-im/chunkr/issues/405)) ([d161fa0](https://github.com/cicero-im/chunkr/commit/d161fa0820fc03ffaf9bdbbf58c124179548a31a))
* Redesign keycloak auth pages ([adaf74b](https://github.com/cicero-im/chunkr/commit/adaf74b2c57b37779794e9e3c736905b02bccff3))
* Update web to use `/task/parse` API route and added `error_handling`, `llm_processing`, `embed_sources` and tokenization settings in the upload component ([#450](https://github.com/cicero-im/chunkr/issues/450)) ([b1a6aef](https://github.com/cicero-im/chunkr/commit/b1a6aef41ff8d73daa9ba435e37219b98c765524))
* Updated llm processing pipeline to be more robust ([#527](https://github.com/cicero-im/chunkr/issues/527)) ([1cfb9ca](https://github.com/cicero-im/chunkr/commit/1cfb9ca10801df57175e5ca148852a48cfea54ed))


### Bug Fixes

* Add Default trait implementation to FallbackStrategy enum ([#479](https://github.com/cicero-im/chunkr/issues/479)) ([d9a2eaf](https://github.com/cicero-im/chunkr/commit/d9a2eaf86470d82e8dfed9af874d3cc49ca76ba5))
* Added back segmentation docker with self hosted runner ([0984ba2](https://github.com/cicero-im/chunkr/commit/0984ba2710fca19a807985e5a92fbf1e185bbb03))
* Added file type attributes to span ([#520](https://github.com/cicero-im/chunkr/issues/520)) ([edd7d0d](https://github.com/cicero-im/chunkr/commit/edd7d0d140bd3482ce195e6f2243a9e67b4a5efa))
* Added imagemagick to docker images ([d3ac921](https://github.com/cicero-im/chunkr/commit/d3ac9215f0c570269ba16f3855512da606fd3d4c))
* Added retry when finish reason is length ([#383](https://github.com/cicero-im/chunkr/issues/383)) ([a8dd777](https://github.com/cicero-im/chunkr/commit/a8dd77791d7294e7166a430776a329e53b0a8103))
* Await was missing in response ([1ad37d8](https://github.com/cicero-im/chunkr/commit/1ad37d851ee0379c13ba663fc8bafb3541e409a2))
* Await was missing in response ([632adce](https://github.com/cicero-im/chunkr/commit/632adce42c7850a788e0e46817e2498724c76890))
* **client:** Polling would error out on httpx.ReadTimeout ([#400](https://github.com/cicero-im/chunkr/issues/400)) ([aea1255](https://github.com/cicero-im/chunkr/commit/aea125533063de8bbddb36741aed5c1c07ba693b))
* Compose-cpu web server replicas ([#467](https://github.com/cicero-im/chunkr/issues/467)) ([41b2433](https://github.com/cicero-im/chunkr/commit/41b2433e6ce747c21a0e157e3759b7f1a27ec5ad))
* Config map in helm chart ([5a08085](https://github.com/cicero-im/chunkr/commit/5a08085e3c72647dd0833cdcc5574e99948298d5))
* Continue on error on docker build ([aca0b44](https://github.com/cicero-im/chunkr/commit/aca0b4444875a1b053924a60380e6ee44a4dc005))
* **core:** Allow PDFs based on extension if the pages can be counted ([#396](https://github.com/cicero-im/chunkr/issues/396)) ([cfbfd01](https://github.com/cicero-im/chunkr/commit/cfbfd0155f5fcfb6245acc7dbedb1baa0b12df0b))
* **core:** Auto-fix clippy warnings ([afa853c](https://github.com/cicero-im/chunkr/commit/afa853cdd6122d75aa61cc743f507e76cd6e2be6))
* **core:** Auto-fix clippy warnings ([#386](https://github.com/cicero-im/chunkr/issues/386)) ([ccb56f9](https://github.com/cicero-im/chunkr/commit/ccb56f95212e5840d931893929c6dec648123e34))
* **core:** Auto-fix clippy warnings ([#393](https://github.com/cicero-im/chunkr/issues/393)) ([0605227](https://github.com/cicero-im/chunkr/commit/06052278229f0fe1c6feec44172e9048bf09ecc1))
* **core:** Auto-fix clippy warnings ([#497](https://github.com/cicero-im/chunkr/issues/497)) ([8469ddf](https://github.com/cicero-im/chunkr/commit/8469ddf179709c40949965be203259231bf6b950))
* **core:** Auto-fix clippy warnings ([#507](https://github.com/cicero-im/chunkr/issues/507)) ([a8c2e70](https://github.com/cicero-im/chunkr/commit/a8c2e70fd5db6503fb38273b611fb7ea16c00422))
* **core:** Auto-fix clippy warnings ([#512](https://github.com/cicero-im/chunkr/issues/512)) ([d9ecf60](https://github.com/cicero-im/chunkr/commit/d9ecf60f308cfe4607673bec172f8fc04d673135))
* **core:** Auto-fix clippy warnings ([#516](https://github.com/cicero-im/chunkr/issues/516)) ([a938056](https://github.com/cicero-im/chunkr/commit/a938056779debec5357ad54b27bf5f0788382ba3))
* **core:** Auto-fix clippy warnings ([#518](https://github.com/cicero-im/chunkr/issues/518)) ([238f47f](https://github.com/cicero-im/chunkr/commit/238f47fdaf5d2e62d12448424d1018eb1803b8f8))
* **core:** Auto-fix clippy warnings ([#528](https://github.com/cicero-im/chunkr/issues/528)) ([7a972ed](https://github.com/cicero-im/chunkr/commit/7a972edddbecce0fcc10edc53669784f6755de89))
* **core:** Auto-fix clippy warnings ([#541](https://github.com/cicero-im/chunkr/issues/541)) ([00db663](https://github.com/cicero-im/chunkr/commit/00db66361022d5566f281badf327a73724da7922))
* **core:** Handle null started_at values with COALESCE in timeout job ([d068be8](https://github.com/cicero-im/chunkr/commit/d068be82b972a6cd830234448e4bbfe5ebb5245a))
* **core:** Update default generation strategies for Picture and Page segments ([5316485](https://github.com/cicero-im/chunkr/commit/5316485aeec2f923f6fb24f9ab1fcab18e275299))
* Correct Rust lint workflow configuration ([0b1a1eb](https://github.com/cicero-im/chunkr/commit/0b1a1ebdf42a2c22ddfcff52fb7356ebb4216287))
* Debugging please release ([e574177](https://github.com/cicero-im/chunkr/commit/e574177cc28c68e86ab08ac5b83328b393b02bf4))
* Debugging please release with core changes ([558a6f9](https://github.com/cicero-im/chunkr/commit/558a6f9fd86c5d6e53b770dd48909a3a60e7f110))
* Default trait added to chunk processing ([20c6f15](https://github.com/cicero-im/chunkr/commit/20c6f15bf5ef1a538413147103313e65e1223e47))
* Docker builds use root version ([82e1768](https://github.com/cicero-im/chunkr/commit/82e176868e215f550377d9aed91e5b37fd57faba))
* Docker compose files update separately ([15328a2](https://github.com/cicero-im/chunkr/commit/15328a23dfd4399b6a56babb18becd04bf7bdf72))
* Docker compose updated uses pr ([f45abd1](https://github.com/cicero-im/chunkr/commit/f45abd130d4c643c288c3492bb27f6736059dfbf))
* Downgraded cuda version for doctr ([36db353](https://github.com/cicero-im/chunkr/commit/36db353079aaf56fd4613ea13b3c88e7d678e897))
* Fix keycloak tag ([df9efa5](https://github.com/cicero-im/chunkr/commit/df9efa5e212a517020e47d66c3820e62ca87acf2))
* Fixed prompts and retries for LLMs ([#394](https://github.com/cicero-im/chunkr/issues/394)) ([4b31588](https://github.com/cicero-im/chunkr/commit/4b3158889747214abc00ee35c634659491e1c07d))
* Fixed timeout query ([97950e5](https://github.com/cicero-im/chunkr/commit/97950e54aaa9c10cc5ce42f75600603c27d73168))
* Formula prompt selection bug ([#484](https://github.com/cicero-im/chunkr/issues/484)) ([3b0942b](https://github.com/cicero-im/chunkr/commit/3b0942b4745739199aa6a8ef11567f05acf4d4cc))
* Github action now removes v from version before tagging ([6c77a1f](https://github.com/cicero-im/chunkr/commit/6c77a1f5f435c362ec62aabb8bd29a78cc7eba1e))
* Image tag updates not full image ([7b8791f](https://github.com/cicero-im/chunkr/commit/7b8791f6bdee1e2b5f47496936700de4ddaee537))
* Improved error handling and telemetry for segment processing ([#515](https://github.com/cicero-im/chunkr/issues/515)) ([2afc82e](https://github.com/cicero-im/chunkr/commit/2afc82e361387b51a5d5ab5f99cf74978917e9e1))
* Improved handling of base64, bytes-like and file-like file content in the python client ([#452](https://github.com/cicero-im/chunkr/issues/452)) ([65e479f](https://github.com/cicero-im/chunkr/commit/65e479f75ecb91e676afcffe1843d4902a8736e7))
* List style points visible now ([#476](https://github.com/cicero-im/chunkr/issues/476)) ([95a9844](https://github.com/cicero-im/chunkr/commit/95a98449bf6b6c8f0befd728ceb8206656966b8d))
* Llm models are now fetched from `VITE_API_URL` ([#457](https://github.com/cicero-im/chunkr/issues/457)) ([06ce1ea](https://github.com/cicero-im/chunkr/commit/06ce1eaa98048753fd065ddb00908b54914f4857))
* Moved infrastructure from values.yaml to infrastructure.yaml ([e4ba284](https://github.com/cicero-im/chunkr/commit/e4ba284b85c3290f585abce36d97c8c9860bdb9a))
* Only trigger docker build after releases created ([676c280](https://github.com/cicero-im/chunkr/commit/676c280e975ea37a8a737876854b0e3aa7006fc2))
* Paths decodable as base64 string can be used with the python client ([#444](https://github.com/cicero-im/chunkr/issues/444)) ([d544aac](https://github.com/cicero-im/chunkr/commit/d544aac952d7a6b45ece09b691ad0d1d4b9454c1))
* Picture default strategy to LLM as default in the generation strategy for html and markdown ([#524](https://github.com/cicero-im/chunkr/issues/524)) ([e44126c](https://github.com/cicero-im/chunkr/commit/e44126c0387fb176f9ac6b027e3d6d0231102591))
* Release-please docker build ([6e1ff43](https://github.com/cicero-im/chunkr/commit/6e1ff43ad0d5780d2f4a6e67b0b2bcc47d8964f6))
* Remove duplicate email addresses in README.md ([e15d2de](https://github.com/cicero-im/chunkr/commit/e15d2defa5f5372837c200c53a29505ae9924d89))
* Remove keycloakify theme ([ea46cbe](https://github.com/cicero-im/chunkr/commit/ea46cbea3e6d6abca04f2c79f8c5bd75d496ac7b))
* Removed segmenetation from docker build ([5dc9e6e](https://github.com/cicero-im/chunkr/commit/5dc9e6e5d1687bbe6ab3555f7df5656856a43f34))
* Replaced vgt with yolo model as it's more practical for consumer hardware ([ff4b906](https://github.com/cicero-im/chunkr/commit/ff4b9063eaa0fabc14586d1176ec528fe77e2fa0))
* Resolve logger warnings ([#510](https://github.com/cicero-im/chunkr/issues/510)) ([8810d5e](https://github.com/cicero-im/chunkr/commit/8810d5ec1ce03c12daa1bee98afed3fb2386cf5a))
* Reverted landing page hero image ([#548](https://github.com/cicero-im/chunkr/issues/548)) ([e798336](https://github.com/cicero-im/chunkr/commit/e7983361fdbb9243c055f2444cacb55aa6072a78))
* Rm extended context default and picture default ([8411eca](https://github.com/cicero-im/chunkr/commit/8411eca5dc9c66833cd431049ada51675d3ce81f))
* Rmeoved changelog from core ([b658a63](https://github.com/cicero-im/chunkr/commit/b658a6373baee8cba156d7272a8c91accda0e0e8))
* Rmeoved changelog from core ([4f7c9c0](https://github.com/cicero-im/chunkr/commit/4f7c9c0595199ae176c883f230713514b889d9a5))
* Solved latex rendering errors and final viewer optimizations in place ([#472](https://github.com/cicero-im/chunkr/issues/472)) ([1fd05c4](https://github.com/cicero-im/chunkr/commit/1fd05c4ca3b499ddeb7549dbf03988a4e30ea1a8))
* Stored cross-site scripting in segmentchunk component ([#546](https://github.com/cicero-im/chunkr/issues/546)) ([49334b7](https://github.com/cicero-im/chunkr/commit/49334b788e742f7453c8987e856b57dcb56f0773))
* Update default for high resolution to true ([#536](https://github.com/cicero-im/chunkr/issues/536)) ([37cc757](https://github.com/cicero-im/chunkr/commit/37cc757ea41acce4a662a127bc141e77b56cda03))
* Update robots.txt and blog post page, added sitemap, and removed toast from auth  ([#535](https://github.com/cicero-im/chunkr/issues/535)) ([3c8f827](https://github.com/cicero-im/chunkr/commit/3c8f82701d4ff40f932b24607da2dfd394f31e60))
* Updated changelog paths ([d20b811](https://github.com/cicero-im/chunkr/commit/d20b8112fc5043f5eecabf1e72e89412b1b5e7b1))
* Updated hashmap to lru for caching ([d868c76](https://github.com/cicero-im/chunkr/commit/d868c76dd16a6751e3baab43190b81e827e26395))
* Updated manual conversion from html to mkd to pandoc ([#539](https://github.com/cicero-im/chunkr/issues/539)) ([16cc847](https://github.com/cicero-im/chunkr/commit/16cc847f5728bd963bf8f367579721098190141c))
* Updated problematic ML dependencies ([#468](https://github.com/cicero-im/chunkr/issues/468)) ([5e60961](https://github.com/cicero-im/chunkr/commit/5e6096122d333b832c8fff1437cb47f70979683e))
* Updated rust version ([5fce4c4](https://github.com/cicero-im/chunkr/commit/5fce4c4496dc02954088373b415ba7722ff076be))
* Updated rust version for docker builds ([e5a3633](https://github.com/cicero-im/chunkr/commit/e5a3633e970dacae3ce08e42f5d7249aed592fa6))
* Use local builds in compose.yaml for easier development ([c53f1de](https://github.com/cicero-im/chunkr/commit/c53f1de5de2bcfcfab7919c04e0ed78f44d3f6e4))
* Viewer optimizations and momentum scroll fix ([#466](https://github.com/cicero-im/chunkr/issues/466)) ([671f840](https://github.com/cicero-im/chunkr/commit/671f84083eb796b9a120e3ad3f57c7a61cbfcde3))


### Performance Improvements

* Improved llm analytics for extraction errors ([#538](https://github.com/cicero-im/chunkr/issues/538)) ([0302499](https://github.com/cicero-im/chunkr/commit/0302499f9942c3f2d0f3888ef419d7e2f6945394))
